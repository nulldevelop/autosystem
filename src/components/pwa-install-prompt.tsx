      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p className="text-sm text-white/60 mt-1 leading-relaxed">
            Adicione o AutoSystem à sua tela inicial para uma experiência mais rápida e em tela cheia.
          </p>
        </div>
        ...
        {isIOS ? (
          <div className="bg-white/5 p-4 rounded-xl text-sm text-white/80 flex flex-col gap-3 border border-white/5">
            <p className="flex items-center gap-3">
              <span className="flex items-center justify-center w-6 h-6 rounded bg-white/10 text-xs font-medium">1</span>
              <span>Toque em compartilhar <Share size={16} className="inline ml-1 text-blue-400" /></span>
            </p>
            <p className="flex items-center gap-3">
              <span className="flex items-center justify-center w-6 h-6 rounded bg-white/10 text-xs font-medium">2</span>
              <span>Selecione "Adicionar à Tela de Início" <PlusSquare size={16} className="inline ml-1" /></span>
            </p>
          </div>
        ) : (
          <Button 
