...
export default async function AuthLayout({
  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning className="dark">
      <body className={`${inter.variable} ${poppins.variable} font-sans antialiased text-white bg-[#0a0a0a]`}>
        <SidebarProvider>
          <AppSidebar />
            ...
            <header className="flex h-16 shrink-0 items-center justify-between gap-2 border-b border-white/5 px-6 sticky top-0 bg-black/40 backdrop-blur-xl z-30">
              ...
              <div className="flex items-center gap-4">
                <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider text-white/60">System Online</span>
                </div>
              </div>
            </header>
