      ...
      <div className="flex flex-col gap-6 shrink-0 px-1">
        <div className="flex flex-col md:flex-row justify-between items-end gap-4">
          ...
          <Button
            ...
            className="glow-primary h-12 px-8 font-black uppercase italic tracking-tighter text-md"
          >
        ...
        <div className="flex flex-col md:flex-row gap-4 bg-zinc-950/50 p-4 rounded-2xl border border-white/5 backdrop-blur-sm">
          <div className="relative flex-1">
            ...
            <Input 
              ...
              className="pl-10 bg-white/[0.02] border-white/10 text-sm focus:border-primary/50 h-12" 
              value={searchTerm}
        ...
        <div className="flex flex-col gap-3 pb-10">
          {filteredVehicles.length > 0 ? (
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="space-y-0.5">
                            <div className="flex items-center gap-2">
                               <Badge variant="outline" className="bg-primary/5 border-primary/20 text-primary text-[10px] font-black h-5 px-1.5 uppercase tracking-tighter">
                            ...
                            <div className="flex items-center gap-2 text-white/40">
                               ...
                               <span className="text-[11px] font-bold uppercase tracking-wider">Ano {vehicle.year}</span>
                            </div>
                          </div>
                        </div>
                      </div>

                      <div className="px-5 py-4 lg:py-0 lg:w-[300px] border-b lg:border-b-0 lg:border-r border-white/5 space-y-1.5">
                         ...
                         <div className="flex flex-col">
                            <span className="text-sm font-bold text-white/80 line-clamp-1">{vehicle.customer?.name || "N/A"}</span>
                            <span className="text-[10px] font-medium text-white/30 line-clamp-1">{vehicle.customer?.email || "Sem e-mail"}</span>
                         </div>
                      </div>

                      <div className="p-4 lg:p-5 lg:w-[320px] bg-white/[0.01] flex items-center justify-end gap-2">
                         <div className="flex items-center gap-2 w-full justify-end">
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent className="bg-zinc-950 border-white/10 text-white">
                                <AlertDialogHeader>
                                  <AlertDialogTitle className="font-black uppercase italic tracking-tighter text-2xl">Remover Veículo?</AlertDialogTitle>
            ...
            <div className="py-24 text-center border-2 border-dashed border-white/5 rounded-[2rem] bg-white/[0.01]">
              <Car className="size-12 text-white/10 mx-auto mb-4" />
              <h3 className="text-xl font-black uppercase text-white/40 italic">Nenhum veículo encontrado</h3>
            </div>
          )}
        </div>
      </ScrollArea>
