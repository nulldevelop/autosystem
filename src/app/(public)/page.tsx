...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a] text-white selection:bg-primary/30 selection:text-white overflow-x-hidden font-sans">
      ...
      {/* --- NAVBAR --- */}
      <nav className="relative z-50 flex justify-between items-center p-6 mx-auto border-b border-white/5 backdrop-blur-xl sticky top-0">
      ...
      <section className="relative z-10 pt-32 pb-40">
        <div className="mx-auto px-6 text-center md:text-left flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1">
            ...
            >
              ...
              <p className="text-xl text-white/40 mb-10 max-w-xl leading-relaxed font-medium">
                Abandone as planilhas. Assuma o controle total do seu negócio
                com a plataforma de alta performance feita para quem entende de
                velocidade.
              </p>
              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="px-10 h-14 text-lg border-white/5 bg-white/5"
                >
                  Ver Demo
                </Button>
              </div>
              ...
              <div className="bg-[#050505] rounded-[1.5rem] overflow-hidden aspect-[4/3] border border-white/5 relative p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                    <p className="text-[8px] font-black text-white/20 uppercase mb-2">
                      Performance Index
                    </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-end gap-1.5 h-24 px-2">
                    {[40, 70, 45, 90, 65, 80, 50, 95, 60, 75].map((h, i) => (
                      <motion.div
                        key={`chart-bar-${i.toString()}`}
                        initial={{ height: 0 }}
                        animate={{ height: `${h}%` }}
                        transition={{ delay: 1 + i * 0.1, duration: 1 }}
                        className="flex-1 bg-linear-to-t from-primary/20 to-primary rounded-t-sm"
                      />
                    ))}
                  </div>
                ...
                <div className="flex items-center justify-between mt-auto">
                  <div className="flex gap-4">
                    <div className="flex flex-col gap-1">
                      <span className="text-[6px] font-black text-white/20 uppercase">
                        Core Status
                      </span>
                ...
                {/* Scanline Effect */}
                <div className="absolute inset-0 pointer-events-none bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.1)_50%),linear-gradient(90deg,rgba(255,0,0,0.02),rgba(0,255,0,0.01),rgba(0,0,255,0.02))] bg-size-[100%_2px,3px_100%] z-20" />
              </div>
            </div>
      ...
      <section
        id="metrics"
        className="relative z-10 py-24 border-y border-white/5 bg-white/1"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            {[
              ...
              >
                ...
                <div className="text-5xl md:text-6xl font-black italic tracking-tighter font-poppins">
                  {m.value}
                </div>
              </motion.div>
            ))}
        ...
        <div className="mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-2xl text-center md:text-left">
              ...
              <p className="text-white/40 text-lg font-medium">
                Cada funcionalidade foi desenhada para eliminar gargalos e
                acelerar o fluxo de trabalho da sua equipe.
              </p>
            </div>
            <a href="#precos">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div
                  className={`p-4 rounded-2xl bg-white/5 w-fit mb-8 group-hover:scale-110 transition-transform ${m.color === "secondary" ? "text-secondary" : "text-primary"}`}
                >
                  {m.icon}
                </div>
                <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-4 font-poppins">
                  {m.title}
                </h3>
        ...
        <div className="mx-auto px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-4 mb-16">
            <button
              ...
              className={`text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer ${billingInterval === "monthly" ? "text-primary" : "text-white/30"}`}
            >
              Faturamento Mensal
            </button>
            <button
              ...
              className="w-12 h-6 rounded-full bg-white/10 border border-white/10 relative cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary/50"
            >
              <motion.div
            ...
            <button
              ...
              className={`text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer ${billingInterval === "yearly" ? "text-primary" : "text-white/30"}`}
            >
            ...
            {subscriptionPlans.map((plan, i) => (
              ...
              >
                ...
                <div className="mb-10 text-left">
                  <h3 className="text-xl font-black italic uppercase tracking-tighter mb-4 text-white/50">
                    {plan.name}
                  </h3>
                  <div className="flex items-baseline gap-1">
                    <span className="text-5xl font-black italic tracking-tighter font-poppins">
                      R$
                    </span>
                ...
                <ul className="text-left space-y-4 mb-10 flex-1">
                  {plan.features.map((feature) => (
                    <li
                      key={`${plan.slug}-feature-${feature}`}
                      className="flex items-center gap-3 text-sm font-bold text-white/40"
                    >
                      <CheckCircle2
                        size={16}
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="glass rounded-[3rem] p-16 text-center border-primary/20 bg-primary/5 relative overflow-hidden">
            ...
            <p className="text-xl text-white/40 mb-12 font-medium relative z-10">
              Junte-se a mais de 1.200 oficinas que transformaram sua gestão com
              o AutoSystem.
            </p>
            <Link href="/auth">
      ...
      <footer className="relative z-10 py-20 border-t border-white/5 text-center">
        <div className="mx-auto px-6 flex flex-col items-center">
          ...
          <p className="text-white/10 text-[9px] uppercase tracking-widest">
            &copy; 2026 AUTO SYSTEM PERFORMANCE ERP. TODOS OS DIREITOS
            RESERVADOS.
          </p>
        </div>
      </footer>
